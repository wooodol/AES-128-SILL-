...
module gfmul(
    ...
    always@(*)begin  
        case(y)
            ...
            8'h09: out = (((((x << 1) ^ (x[7] ? 8'h1b : 8'h00)) << 1) ^ (x[7] ? 8'h1b : 8'h00)) << 1) ^ (x[7] ? 8'h1b : 8'h00) ^ x;
            8'h0b: out = (((((x << 1) ^ (x[7] ? 8'h1b : 8'h00)) << 1) ^ (x[7] ? 8'h1b : 8'h00)) ^ x) << 1 ^ (x[7] ? 8'h1b : 8'h00) ^ x;
            8'h0d: out = (((((x << 1) ^ (x[7] ? 8'h1b : 8'h00)) ^ x) << 1) ^ (x[7] ? 8'h1b : 8'h00)) << 1 ^ (x[7] ? 8'h1b : 8'h00);
            8'h0e: out = (((x << 1) ^ (x[7] ? 8'h1b : 8'h00)) << 1) ^ (x[7] ? 8'h1b : 8'h00);
            default : out = 8'b0;
        endcase 
    end
endmodule 
